...
* [2. Setup 安装指南](s02/00_setup.md)
   ...
   * [2.2 Running as a Service on Linux 运行为一个 Linux 服务](s02/02_running_as_a_service_on_linux.md)
   * [2.3 Running as a Service on Windows 运行为一个 Windows 服务](s02/03_running_as_a_service_on_windows.md)
   * 2.4 Directory Layout
   * 2.5 Repositories
   * 2.6 Upgrading
* [Breaking changes](s03/00_breaking_changes.md)
* [API Conventions](s04_00_api_conventions.md)
* Document APIs
* Search APIs
* Aggregations
* Indices APIs
